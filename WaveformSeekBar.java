...
//        canvas.drawText( ((double)getProgress()/getMax())+"", viewWidthHalf, viewHeightHalf, graphPaint );
    ...
    private void readWavFile(File audioFile) throws IOException, WavFileException {

        //String file = "res/raw/test.txt";
        //InputStream in = this.getClass().getClassLoader().getResourceAsStream(file);
        //audioFile = this.getClass().getClassLoader().getResources("/src/main/assets/audio.wav"); //dobijem input stream
        ...
        for (k = 0; k < (yAxis.size() - 1); k++) {
            ...
            Log.e(" min i max su ",  " // " + (yAxis.get(k) * ratio));
